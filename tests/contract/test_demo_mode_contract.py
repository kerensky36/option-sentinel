...
_DEMO_POSITIONS_SPREADS = [
    ...
    # SPY iron condor (4 legs) — for US3 multi-leg grouped spread graph verification
    {
...
class TestDemoPositionsSpreadsSchema:
    def test_count(self):
        assert len(_DEMO_POSITIONS_SPREADS) == 10
